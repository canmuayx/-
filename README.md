...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('UnDead Hub BF Premium') then
        makefolder('UnDead Hub BF Premium')
    end
    if not _G.Dis and not isfile('UnDead Hub BF Premium/'..Name..'.json') then
        writefile('UnDead Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('UnDead Hub BF Premium') and isfile('UnDead Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('UnDead Hub BF Premium/'..Name..'.json'))
...
function Text(value)
    game.StarterGui:SetCore("SendNotification", {
        Title = "UnDead Notification", 
        Text = tostring(value),
        Icon = "http://www.roblox.com/asset/?id=8477943628",
        Duration = 10
    })
end
function Com()
...
local win = library:Window("UnDead",[[Hub]],[[Version : Premium ]],"8468460956",Enum.KeyCode.RightControl)
...
local Credit_Tab = win:Tab("Credit",[[5012544693]])

Credit_Tab:Label("                                Bearki&Catomka")
Credit_Tab:Button("Copy Link Discord",function()

	setclipboard("https://discord.gg/N2tbDJZb")
end)
